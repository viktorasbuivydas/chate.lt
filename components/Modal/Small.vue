<template>
  <div class="px-4 py-12">
    <div
      role="alert_alert_8"
      id="alert_alert_8"
      class="transition duration-150 ease-in-out lg:max-w-[260px] max-w-[246px] w-full mx-auto bg-white py-8 px-4 relative rounded-md"
    >
      <svg
      ...
      <div class="mx-auto">
        ...
        <p
          class="mt-4 mb-3 text-base font-semibold leading-normal text-center text-gray-800"
        >
          Success Message
        </p>
        <p class="text-xs leading-[18px] text-center text-gray-600">
          The content of this message will go <br />
          here! you can add as much as you want to add.
        </p>

        <div class="flex items-center justify-center mt-4 gap-x-3">
          <p
            class="text-xs font-medium leading-3 text-center text-[#10B981] cursor-pointer hover:underline"
          >
            View Details
          </p>
          <p
            onclick="closeAlert_alert_8()"
            class="text-xs font-medium leading-3 text-center text-gray-600 cursor-pointer"
          >
            Dismiss
          </p>
        </div>
...
<script>
var Alert_alert_8 = document.getElementById("alert_alert_8");
var close_alert_8 = document.getElementById("close-modal_alert_8");
Alert_alert_8.style.transform = "translateY(0%)";
function closeAlert_alert_8() {
  Alert_alert_8.style.transform = "translateY(-200%)";
