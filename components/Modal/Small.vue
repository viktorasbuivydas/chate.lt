<template>
  <div
    v-if="showModal"
    class="fixed w-full h-full left-0 top-0 z-10"
    :style="{ backdropFilter: 'blur(5px) contrast(.6)' }"
  >
    <div class="mx-auto w-1/2">
      <div class="px-4 py-12">
        <div
          ...
          class="shadow-lg transition duration-150 ease-in-out lg:max-w-[260px] max-w-[246px] w-full mx-auto bg-white py-8 px-4 relative rounded-md"
        >
          <button @click="close">
            <svg
