  ...
  <div>
        ...
        >
          <div class="xl:pr-16 w-full xl:w-2/3">
            ...
            >
              <a
                tabindex="0"
                class="focus:outline-none text-gray-800 dark:text-gray-100 focus:outline-none"
              >
                <h2
              ...
              <p
                tabindex="0"
                class="focus:outline-none text-sm bg-indigo-700 dark:bg-indigo-600 text-white px-5 py-1 font-normal rounded-full"
              >
                Savininkas
              </p>
            </div>
          ...
          >
            <div class="mr-6 xl:mr-10">
              <h2
                tabindex="0"
                class="focus:outline-none text-gray-600 dark:text-gray-400 font-bold text-xl xl:text-2xl leading-6 mb-2 text-center"
              >
                82
              </h2>
              <a
              ...
              >
                <p class="text-sm xl:text-xl leading-5">Reviews</p></a
              >
            </div>
            <div class="mr-6 xl:mr-10">
              <h2
              ...
              <a
                ...
                class="focus:outline-none text-gray-800 dark:text-gray-100"
              >
                <p class="text-sm xl:text-xl leading-5">Projects</p></a
              >
            </div>
            <div>
              <h2
              ...
              <a
                ...
                class="focus:outline-none text-gray-800 dark:text-gray-100"
              >
                <p class="text-sm xl:text-xl leading-5">Approved</p></a
              >
            </div>
          </div>
          <div
          ...
          >
            ...
            >
              <div
                tabindex="0"
                class="focus:outline-none rounded-full bg-gray-100 text-gray-700 dark:text-gray-400 text-sm px-6 py-2 flex justify-center items-center"
              >
                Remote
              </div>
              <div
                tabindex="0"
                class="focus:outline-none ml-5 rounded-full bg-green-100 text-green-700 text-sm px-6 py-2 flex justify-center items-center"
              >
                Available
              </div>
            </div>
            <button
              class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:bg-indigo-600 ml-0 md:ml-5 bg-indigo-700 dark:bg-indigo-600 transition duration-150 ease-in-out hover:bg-indigo-600 rounded text-white px-3 md:px-6 py-2 text-sm"
            >
              Message
            </button>
          </div>
    ...
    <!-- <div class="flex flex-col flex-grow p-2" v-if="user">
        <div>
          ...
          <div>Statusas:</div>
          <b>{{ user.username }}</b>
          <div>Reputacija: 34 +1 -1</div>
          <div>Projektai: [array]</div>
          <div>Forume zinuciu</div>
          <div>Pokalbiuose zinuciu</div>
          <div>forume temu</div>
          <div>reputacijos tasku</div>
